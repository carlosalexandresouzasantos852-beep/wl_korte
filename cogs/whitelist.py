...
class WhitelistView(View):
    ...
    async def send_embed_temporary(self, canal, titulo, descricao, duracao):
        ...
        embed.set_footer(text="Whitelist System - TROPA DO TIO PATINHAS")
    ...
    async def aprovar(self, interaction: discord.Interaction, button: Button):
        ...
        try:
            ...
            nick_msg = f"❌ Não foi possível alterar o nickname de {self.usuario.mention}.\n"
...
class Whitelist(commands.Cog):
    ...
    async def painel_wl(self, interaction: discord.Interaction, gif_url: str = None):
        ...
        embed = discord.Embed(
            title="📋 PAINEL DE WHITELIST TROPA DO TIO PATINHAS",
